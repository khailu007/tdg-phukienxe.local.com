<?php
/**
 * The template for displaying all single posts - Sản xuất Nhôm
 *
...
if(get_post_type()=='sp_inox' && !empty(pix_get_option('blog-full-width-layout'))){
                ...
                if(get_post_type()=='sp_inox'){
                    switch ($blog_layout) {
                        ...
                        case 'default-normal':
                            ...
                            break;
                        default:
                            get_template_part( 'template-parts/content', 'sp-inox' );
                    }
