...
5) Click **Authorize** .An authorization screen is displayed. 
6) Click the **Accept** button to allow access of data from your Zoho Account.
7) Once the authentication process is done, you can choose the From Email address and the Mail format in which the emails should be sent from your WordPress site.
8) Provide a From Name to be displayed in the emails sent.

Once done, you can send emails from your Wordpress site using Zoho Mail
...
2. [Configure Account](screenshot-2.png)
3. [Test Mail](screenshot-3.png)

== Changelog ==
= 1.0.1 =
* Added notification for successful authentication while configuring.
...
= 1.3.8 =
* Issue fix for [Php Warnings](https://wordpress.org/support/topic/bugs-in-newest-version/)
= 1.3.9 =
* Attachment fix
= 1.4.0 =
...
= 1.5.1 =
* bug fix for configuration settings UI issue.
= 1.5.2 =
* Enhanced the settings flow.
= 1.5.3 =
* bug fix for issue in large file upload.
